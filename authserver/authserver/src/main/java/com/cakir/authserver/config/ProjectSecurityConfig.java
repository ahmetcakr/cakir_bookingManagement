package com.cakir.authserver.config;
...
public class ProjectSecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient clientCredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("cakirauthapi")
                .clientSecret("{noop}XkmsdSdkmsdkmas9q9sdöliSijdwmdkTTy")
        ...
        RegisteredClient authCodeClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("cakirauthclient")
                .clientSecret("{noop}DmksdkmSrCvmsdSDiermfSEiSeIgs")
        ...
        RegisteredClient pkceClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("cakirauthpublicclient")
